    ...
    <section id="plan" className="py-20 bg-white overflow-hidden">
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-[#005900] mb-4">Plan de Negocio</h2>
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">Estrategia integral para el crecimiento sostenible</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 flex flex-col items-center">
                ...
                <table className="w-full text-sm md:text-base min-w-[600px]">
                  <thead>
                    <tr className="bg-[#005900] text-white">
                      <th className="p-3 md:p-4 text-left font-semibold whitespace-nowrap">Concepto</th>
                      <th className="p-3 md:p-4 text-center font-bold bg-[#0a7a0a] whitespace-nowrap">Lanzamiento</th>
                      <th className="p-3 md:p-4 text-center font-bold bg-[#005900] whitespace-nowrap">Crecimiento Anual</th>
                      <th className="p-3 md:p-4 text-center font-bold bg-[#0a7a0a] whitespace-nowrap">Forecast 5 años</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100 text-gray-700">
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="p-3 md:p-4 font-bold text-[#005900] whitespace-nowrap">Consultoría</td>
                      <td className="p-3 md:p-4 text-center font-medium">15%</td>
                      <td className="p-3 md:p-4 text-center font-medium">18%</td>
                      <td className="p-3 md:p-4 text-center font-medium">13%</td>
                    </tr>
                    <tr className="bg-green-50/30 hover:bg-green-50 transition-colors">
                      <td className="p-3 md:p-4 font-bold text-[#005900] whitespace-nowrap">Servicios</td>
                      <td className="p-3 md:p-4 text-center font-bold text-green-700">52%</td>
                      <td className="p-3 md:p-4 text-center font-medium">37%</td>
                      <td className="p-3 md:p-4 text-center font-bold text-green-700">57%</td>
                    </tr>
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="p-3 md:p-4 font-bold text-[#005900] whitespace-nowrap">Repuestos</td>
                      <td className="p-3 md:p-4 text-center font-medium">33%</td>
                      <td className="p-3 md:p-4 text-center font-medium">25%</td>
                      <td className="p-3 md:p-4 text-center font-medium">30%</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <p className="text-xl md:text-2xl text-center font-medium text-[#005900] leading-relaxed max-w-2xl">
              "La introducción al 1% del mercado actual explorado nos ha permitido un crecimiento sostenible del negocio."
            </p>
          </div>

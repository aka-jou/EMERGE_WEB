      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 flex flex-col items-center">
            <div className="w-full overflow-hidden rounded-xl shadow-lg border border-gray-200 bg-white mb-8">
              <table className="w-full text-sm md:text-base">
                <thead>
                  <tr className="bg-[#005900] text-white">
                    <th className="p-4 text-left font-semibold">Concepto</th>
                    <th className="p-4 text-center font-bold bg-[#0a7a0a]">Lanzamiento</th>
                    <th className="p-4 text-center font-bold bg-[#005900]">Crecimiento Anual</th>
                    <th className="p-4 text-center font-bold bg-[#0a7a0a]">Forecast 5 años</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100 text-gray-700">
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="p-4 font-bold text-[#005900]">Consultoría</td>
                    <td className="p-4 text-center font-medium">15%</td>
                    <td className="p-4 text-center font-medium">18%</td>
                    <td className="p-4 text-center font-medium">13%</td>
                  </tr>
                  <tr className="bg-green-50/30 hover:bg-green-50 transition-colors">
                    <td className="p-4 font-bold text-[#005900]">Servicios</td>
                    <td className="p-4 text-center font-bold text-green-700">52%</td>
                    <td className="p-4 text-center font-medium">37%</td>
                    <td className="p-4 text-center font-bold text-green-700">57%</td>
                  </tr>
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="p-4 font-bold text-[#005900]">Repuestos</td>
                    <td className="p-4 text-center font-medium">33%</td>

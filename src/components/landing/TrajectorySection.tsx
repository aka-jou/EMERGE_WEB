    ...
    >
      <div className="flex flex-col gap-3 mb-4">
        <div className="flex items-center justify-between">
          <span className={`px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider ${item.badgeColor}`}>
            {item.badge}
          </span>
    ...
    <section id="timeline" className="py-24 bg-gray-50 overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-20 relative z-10">
        <div className="text-center mb-28">
          ...
          <p className="max-w-2xl mx-auto text-gray-500 text-lg">De cimientos sólidos a liderazgo de mercado.</p>
        </div>
